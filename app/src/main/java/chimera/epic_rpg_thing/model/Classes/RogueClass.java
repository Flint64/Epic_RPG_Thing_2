...
public class RogueClass extends CharacterClass {
    public RogueClass(){
        ...
        this.addWeaknesses(new ElementalEffect(ElementalType.FIRE, (int)1));
        initializeSkills();
    }
    ...
    private void initializeSkills(){
        classSkills.put("StabbyStab1", SingleSkillFactory.create(SingleType.DAMAGE, 0, 6, 10, null, new ElementalEffect(ElementalType.PHYSICAL, (int) 1), "Stabby stab"));
        classSkills.put("DarkSlash1", SingleSkillFactory.create(SingleType.DAMAGE_DEBUFF, 0, 3, 4, new Benefit((int)0,(int)0,(int)0,0,0, 0,0,-2, new SingleBuff(),2, false), new ElementalEffect(ElementalType.SHADOW, (int)1), "From the shadows the rogue strikes"));
    }
}
