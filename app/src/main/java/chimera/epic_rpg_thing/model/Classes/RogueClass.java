...
public class RogueClass extends CharacterClass {
    ...
    private void initializeSkills(){
        ...
        classSkills.put("DarkSlash1", SingleSkillFactory.create(SingleType.DAMAGE_DEBUFF, 0, 3, 4, new Benefit(0,0,0,0,0, 0,0,-2, new SingleBuff(),2, false), new ElementalEffect(ElementalType.SHADOW, 1), "From the shadows the rogue strikes"));
    }
}
