...
public class selectSkillsActivity extends AppCompatActivity {
    ...
    //         final CheckBox skill1 = findViewById(R.id.selectSkill_1);
//         final CheckBox skill2 = findViewById(R.id.selectSkill_2);
//         final CheckBox skill3 = findViewById(R.id.selectSkill_3);
//         final CheckBox skill4 = findViewById(R.id.selectSkill_4);
//
...
//                 skill_3_label.setText("Meditate - Increase damage of next magic attack");
...
//         skill_1_label.setVisibility(View.VISIBLE);
//         skill_2_label.setVisibility(View.VISIBLE);
//         skill_3_label.setVisibility(View.VISIBLE);
//         skill_4_label.setVisibility(View.VISIBLE);
}
